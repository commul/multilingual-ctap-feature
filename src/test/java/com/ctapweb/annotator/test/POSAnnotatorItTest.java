 ...
 */
public class POSAnnotatorItTest {
	JCas jCas;
	...
	public void setUp() throws Exception {
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguage ("src/main/resources/descriptor/annotator/POSAnnotator.xml", "src/test/resources/org.apache.uima.fit/POSAnnotatorForUIMAFitTest.xml", "IT");
	...
	/*
	 * Tests that the number of POS tags in the text cani.txt is equal to 297
	 */
