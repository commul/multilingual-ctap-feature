...
public class SyllableAnnotatorTest {
	...
	public void setUp() throws Exception {
		...
		DescriptorModifier.readXMLTypeDescriptorModifyImports ("src/main/resources/descriptor/type_system/linguistic_type/SyllableType.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/SyllableTypeForUIMAFitTest.xml", locationsList);
		String syllableTypeDescr = new String(Files.readAllBytes(Paths.get(System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/SyllableTypeForUIMAFitTest.xml")));
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguage ("src/main/resources/descriptor/annotator/SyllableAnnotator.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/SyllableAnnotatorForUIMAFitTest.xml", "IT");
