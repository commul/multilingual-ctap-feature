...
public class ParseTreeAnnotatorTest {
	JCas jCas;
	XMLParser pars;
	...
	public void setUp() throws Exception {
		...
		DescriptorModifier.readXMLTypeDescriptorModifyImports ("src/main/resources/descriptor/type_system/linguistic_type/ParseTreeType.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/ParseTreeTypeForUIMAFitTest.xml", locationsList);
		String sdSentenceLengthTypeDescr = new String(Files.readAllBytes(Paths.get(System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/ParseTreeTypeForUIMAFitTest.xml")));
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguage ("src/main/resources/descriptor/annotator/ParseTreeAnnotator.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/ParseTreeAnnotatorForUIMAFitTest.xml", "IT");
