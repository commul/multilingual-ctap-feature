...
public class TokenTypeAnnotatorTest {
	...
	public void setUp() throws Exception {
		...
		DescriptorModifier.readXMLTypeDescriptorModifyImports("src/main/resources/descriptor/type_system/linguistic_type/TokenTypeType.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/TokenTypeTypeForUIMAFitTest.xml", locationsList);
		String lemmaTypeDescr = new String(Files.readAllBytes(Paths.get(System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/TokenTypeTypeForUIMAFitTest.xml")));
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguage ("src/main/resources/descriptor/annotator/TokenTypeAnnotator.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/TokenTypeAnnotatorForUIMAFitTest.xml", "IT");
