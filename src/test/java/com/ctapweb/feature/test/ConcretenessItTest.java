...
public class ConcretenessItTest {
	JCas jCas;
	...
	@Test
	public void ConcretenessAllLemmasFeatureTest() throws Exception {
	...
	@Test
	public void ConcretenessUniqueLemmasFeatureTest() throws Exception {
		paramsHashMap = new HashMap <String, ArrayList <String>> ();		
		ArrayList dynamicStringArray = new ArrayList(2);
		String[] names = {"integer", "9872"};
		dynamicStringArray.addAll(Arrays.asList(names));
