...
public class CohesiveComplexityItTest {
	...
	public void CohesionComplexityAdversativeFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_Breindl_Adversative_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_Breindl_Adversative_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_AdversativePerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_AdversativePerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityArgumentativeFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_argumentative_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_argumentative_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_ArgumentativePerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_ArgumentativePerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityConsequenceFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_consequence_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_consequence_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_ConsequencePerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_ConsequencePerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityHierarchyFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_hierarchy_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_hierarchy_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_HierarchyPerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_HierarchyPerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityHypotheticalConditionalFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_hypothetical_conditional_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_hypothetical_conditional_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_HypotheticalConditionalPerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_HypotheticalConditionalPerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityMultifunctionalFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_multifunctional_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_multifunctional_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_MultifunctionalPerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_MultifunctionalPerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityPurposeFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_purpose_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_purpose_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_PurposePerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_PurposePerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void CohesionComplexityExplicativeFeatureTest() throws Exception {		
    	File fACFeature = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/NConnectives_explicative_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NConnectives_explicative_FeatureForUIMAFitTest.xml", paramsHashMapAC, locationsListForTestAC);
		XMLInputSource xmlInputSourceACFeature = new XMLInputSource(fACFeature);
		aedACFeature = pars.parseAnalysisEngineDescription(xmlInputSourceACFeature);
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/CohesiveComplexity_ExplicativePerToken_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/CohesiveComplexity_ExplicativePerToken_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
