...
public class SDSentenceLengthFeatureItTest {
	...
	public void SDSentenceLengthInTokenFeatureTest() throws Exception {
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddUnitAddaeID ("src/main/resources/descriptor/featureAE/SDSentenceLengthInTokenFeature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/SDSentenceLengthInTokenFeatureForUIMAFitTest.xml", "IT", "unit", "token", "9999");
