...
public class POSDensityFeatureItTest {
	...
	public void POSDensityAbbreviationFeatureTest() throws Exception {
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_Abbreviation_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_Abbreviation_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
	...
	public void POSDensityAdjectivePossessiveFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_AdjectivePossessive_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_AdjectivePossessive_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityAdjectiveSingularFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_AdjectiveSingular_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_AdjectiveSingular_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityAdjectivePluralFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_AdjectivePlural_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_AdjectivePlural_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityAdverbNegationFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_AdverbNegation_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_AdverbNegation_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityEmoticonFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_Emoticon_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_Emoticon_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityOrdinalNumberFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_OrdinalNumber_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_OrdinalNumber_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityPluralNounFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_PluralNoun_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_PluralNoun_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityPredeterminerFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_Predeterminer_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_Predeterminer_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensitySingularNounFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_SingularNoun_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_SingularNoun_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensitySymbolFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_Symbol_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_Symbol_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityTwitterTagFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_TwitterTag_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_TwitterTag_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerb3dPersonFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_Verb3dPerson_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_Verb3dPerson_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbConditionalFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbConditional_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbConditional_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbConjunctiveFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbConjunctive_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbConjunctive_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbConjunctiveImperfectFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbConjunctiveImperfect_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbConjunctiveImperfect_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbConjunctivePresentFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbConjunctivePresent_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbConjunctivePresent_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbImperativeFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbImperative_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbImperative_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbIndicativeFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbIndicative_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbIndicative_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbIndicativeFutureFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbIndicativeFuture_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbIndicativeFuture_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbIndicativeImperfectFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbIndicativeImperfect_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbIndicativeImperfect_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbIndicativePastFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbIndicativePast_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbIndicativePast_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
	...
	public void POSDensityVerbIndicativePresentFeatureTest() throws Exception {		
		...
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddParamsFromHashModifyImports ("src/main/resources/descriptor/featureAE/POSDensity_VerbIndicativePresent_Feature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/POSDensity_VerbIndicativePresent_FeatureForUIMAFitTest.xml", paramsHashMap, locationsListForTest);
		XMLInputSource xmlInputSource = new XMLInputSource(f);
		AnalysisEngineDescription aed = pars.parseAnalysisEngineDescription(xmlInputSource);
