...
public class NLemmasFeatureItTest {
	JCas jCas;
	...
	public void setUp() throws Exception {
		...
		DescriptorModifier.readXMLTypeDescriptorModifyImports ("src/main/resources/descriptor/type_system/feature_type/NLemmaType.xml", testResourcesFolder+"NLemmaTypeForUIMAFitTest.xml", locationsList);
		String sdSentenceLengthTypeDescr = new String(Files.readAllBytes(Paths.get(testResourcesFolder+"NLemmaTypeForUIMAFitTest.xml")));
		...
		AnalysisEngineDescription aedLemma = pars.parseAnalysisEngineDescription(xmlInputSourceLemma);
		
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddaeID ("src/main/resources/descriptor/featureAE/NLemmaFeature.xml", testResourcesFolder+"NLemmaFeatureForUIMAFitTest.xml", "IT", "9015");
	...
	@Test
	public void NLemmasFeatureTest() throws Exception {
