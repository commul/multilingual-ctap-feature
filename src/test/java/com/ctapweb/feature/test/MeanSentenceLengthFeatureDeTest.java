...
public class MeanSentenceLengthFeatureDeTest {
	...
	public void setUp() throws Exception {
		...
		locationsList.add("../../../main/resources/descriptor/type_system/feature_type/NSentenceType.xml");
		...
		File fNSentence = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddaeID ("src/main/resources/descriptor/featureAE/NSentenceFeature.xml", testResourcesFolder+"NSentenceFeatureForUIMAFitTest.xml", "DE", "22231");
