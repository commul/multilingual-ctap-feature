...
public class AoAItTest {
	...
	/*
	 * Checks that the Age of Acquisition of lemmas in META-INF/cani.txt is 2.378125.
	 */
	
	@Test
	public void AoAAllLemmasFeatureTest() throws Exception {
	...
	/*
	 * Checks that the Age of Acquisition of unique lemmas in META-INF/cani.txt is 2.7045454545454546.
	 */
	
	@Test
	public void AoAUniqueLemmasFeatureTest() throws Exception {
		paramsHashMap = new HashMap <String, ArrayList <String>> ();		
		ArrayList dynamicStringArray = new ArrayList(2);
		String[] names = {"integer", "9872"};
		dynamicStringArray.addAll(Arrays.asList(names));
