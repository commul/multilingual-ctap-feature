...
public class TTRFeatureItTest {
	...
	public void setUp() throws Exception {
		...
		String sdSentenceLengthTypeDescr = new String(Files.readAllBytes(Paths.get(System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/TypeTokenRatioTypeForUIMAFitTest.xml")));
		...
		File fTokenType = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguage ("src/main/resources/descriptor/annotator/TokenTypeAnnotator.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/TokenTypeAnnotatorForUIMAFitTest.xml", "IT");
		...
		File fNTokenType = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddaeID ("src/main/resources/descriptor/featureAE/NTokenTypeFeature.xml", System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/NTokenTypeFeatureForUIMAFitTest.xml", "IT", "123");
