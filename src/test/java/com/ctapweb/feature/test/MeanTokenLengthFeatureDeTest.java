...
public class MeanTokenLengthFeatureDeTest {
	...
	public void setUp() throws Exception {
		...
		File fNSyllable = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddaeID ("src/main/resources/descriptor/featureAE/NSyllableFeature.xml", testResourcesFolder+"NSyllableFeatureForUIMAFitTest.xml", "DE", "777");
		...
		File fNLetter = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddaeID ("src/main/resources/descriptor/featureAE/NLetterFeature.xml", testResourcesFolder+"NLetterFeatureForUIMAFitTest.xml", "DE", "777");
	...
	public void MeanTokenLengthInLetterFeatureTest() throws Exception {
		File f = DescriptorModifier.readXMLAnnotatorDescriptorAddLanguageAddUnitAddaeID ("src/main/resources/descriptor/featureAE/MeanTokenLengthInLetterFeature.xml", testResourcesFolder+"MeanTokenLengthInTokenFeatureForUIMAFitTest.xml", "DE", "unit", "letter", "12222");
