...
public class LexicalPercentageItTest {
	...
	public void setUp() throws Exception {
		...
		String lexPercTypeDescr = new String(Files.readAllBytes(Paths.get(System.getProperty("user.dir")+"/META-INF/org.apache.uima.fit/LexicalPercentageTypeForUIMAFitTest.xml")));
